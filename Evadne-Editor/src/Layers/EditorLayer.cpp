...
namespace Evadne {
	...
	void EditorLayer::OnAttach()
	{
		...
		Evadne::FramebufferSpecification fbSpec;
		fbSpec.Width = 1280;
		fbSpec.Height = 720;
		m_Framebuffer = Evadne::Framebuffer::Create(fbSpec);
	}
	void EditorLayer::OnDetach()
	{
		EV_PROFILE_FUNCTION();
	}
	void EditorLayer::OnUpdate(Evadne::Timestep ts)
	{
		EV_PROFILE_FUNCTION();

		if(Evadne::FramebufferSpecification spec = m_Framebuffer->GetSpecification(); 
	...
	void EditorLayer::OnEvent(Evadne::Event& e)
	{
