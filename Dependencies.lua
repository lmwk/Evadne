...
IncludeDir["mono"] = "%{wks.location}/Evadne/vendor/mono/include"
...
LibraryDir["mono"] = "%{wks.location}/Evadne/vendor/mono/lib/%{cfg.buildcfg}"

Library = {}

Library["mono"] = "%{LibraryDir.mono}/libmono-static-sgen"
